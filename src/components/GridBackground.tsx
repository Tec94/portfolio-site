...
export default function GridBackground() {
  ...
  const gridY = useTransform(scrollYProgress, [0, 1], ['200px', '400px']);
  const gridOpacity = useTransform(scrollYProgress, [0, 0.3, 0.7, 1], [0.1, 0.15, 0.15, 0.1]);
  const horizonY = useTransform(scrollYProgress, [0, 1], ['50%', '60%']);
  ...
  return (
    <div className="fixed inset-0 -z-20 overflow-hidden">
      ...
      {/* Corner accents with subtle glow animation */}
      <motion.div
